...
class ReverseRotate3SectionsArrayTest {
    ...
    void accept() {
        ...
        new ReverseRotate3SectionsArray<Integer>().accept(input, new ReverseRotate3SectionsArray.RotationSpecs(3, 5));

        // then
        assertThat(input).containsExactly(6, 7, 8, 9, 3, 4, 5, 0, 1, 2);
    }
}
